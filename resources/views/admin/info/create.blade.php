...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Добавить записи</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
            @if (session('success'))
                        ...
                        <form action="{{ route('baseCreateOnly') }}" method="POST"  >
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="id_client" class="form-control" id="exampleInputNameID" placeholder="ID клиента"  required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName">Номер телефона</label>
                                    <input type="text" name="phone" class="form-control" id="exampleInputName" placeholder="Номер телефона" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Поле 1</label>
                                    <input type="text" name="field_1" class="form-control" id="exampleInputEmail1"  placeholder="Поле 1"  >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Поле 2</label>
                                    <input type="text" name="field_2" class="form-control" id="exampleInputEmail1"  placeholder="Поле 2" >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Поле 3</label>
                                    <input type="text" name="field_3" class="form-control" id="exampleInputEmail1"  placeholder="Поле 3" >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Поле 4</label>
                                    <input type="text" name="field_4" class="form-control" id="exampleInputEmail1" placeholder="Поле 4" >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Менеджер</label>
                                    <input type="text" name="manager" class="form-control" id="exampleInputPassword1"  placeholder="Менеджер"  >
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="commit" class="form-control" id="exampleInputPassword2"   placeholder="Комментарий" >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword2">ФИО</label>
                                    <input type="text" name="user_info" class="form-control" id="exampleInputPassword2" placeholder="ФИО"  >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword2">Стран</label>
                                    <input type="text" name="country" class="form-control" id="exampleInputPassword2"   placeholder="Стран" >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword2">Город</label>
                                    <input type="text" name="city" class="form-control" id="exampleInputPassword2"  placeholder="Город"  >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword2">Пол</label>
                                    <input type="text" name="sex" class="form-control" id="exampleInputPassword2"  placeholder="Пол"  >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword2">Дата рождения</label>
                                    <input type="date" name="birthday" class="form-control" id="exampleInputPassword2"   placeholder="Дата рождения"  >
                                </div>
                            </div>
                            <!-- /.card-body -->
                            <div class="card-footer">
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <h5>3. Проверить в поле статус и сравнить со статусами в crm. Если есть недостающие добавить.</h5>
